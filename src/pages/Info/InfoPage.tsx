      ...
      <section className='mt-[80px] max-w-6xl mx-auto p-10 h-fit'>
        ...
        <div className='h-fit'>
          <div className='flex flex-col md:flex-row gap-8 mb-10'>
            <div className=' w-full md:w-1/2 flex flex-col justify-around bg-slate-200 p-8 rounded-md'> 
          ...
          <div className='flex flex-col gap-8 w-full'>
            ...
            <section className='flex flex-col items-center gap-4 sm:gap-8 h-fit p-4 sm:p-8 rounded-md bg-slate-400'>
              <h1 className='text-2xl opacity-80'>Pollutants</h1>
              {Object.keys(station.forecast.daily).slice(0, 3).map((key, index) => (
                <div className='bg-slate-200 rounded-md p-5 shadow-lg w-full' key={index}>
